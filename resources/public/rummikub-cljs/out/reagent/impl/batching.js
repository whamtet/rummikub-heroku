...
{var C_5460 = (a[i]);if(cljs.core.truth_(C_5460.cljsIsDirty))
{C_5460.forceUpdate();
} else
{}
{
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_5462 = C.cljsRatom;if(!((ratom_5462 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_5462);
} else
{}
