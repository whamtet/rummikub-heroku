...
goog.require('cljs.reader');
taoensso.sente.interfaces.IPacker = (function (){var obj16316 = {};return obj16316;
})();
...
{if((function (){var G__16318 = x;if(G__16318)
...
{return G__16318.taoensso$sente$interfaces$IPacker$;
}
})()))
{return true;
} else
{if((!G__16318.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,taoensso.sente.interfaces.IPacker,G__16318);
} else
{return false;
}
}
