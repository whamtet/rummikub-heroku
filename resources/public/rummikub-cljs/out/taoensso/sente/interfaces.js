...
goog.require('cljs.reader');
taoensso.sente.interfaces.IPacker = (function (){var obj15907 = {};return obj15907;
})();
taoensso.sente.interfaces.pack = (function pack(_,x){if((function (){var and__3548__auto__ = _;if(and__3548__auto__)
...
{var x__4187__auto__ = (((_ == null))?null:_);return (function (){var or__3560__auto__ = (taoensso.sente.interfaces.pack[goog.typeOf(x__4187__auto__)]);if(or__3560__auto__)
{return or__3560__auto__;
} else
{var or__3560__auto____$1 = (taoensso.sente.interfaces.pack["_"]);if(or__3560__auto____$1)
...
taoensso.sente.interfaces.unpack = (function unpack(_,x){if((function (){var and__3548__auto__ = _;if(and__3548__auto__)
...
{var x__4187__auto__ = (((_ == null))?null:_);return (function (){var or__3560__auto__ = (taoensso.sente.interfaces.unpack[goog.typeOf(x__4187__auto__)]);if(or__3560__auto__)
{return or__3560__auto__;
} else
{var or__3560__auto____$1 = (taoensso.sente.interfaces.unpack["_"]);if(or__3560__auto____$1)
{return or__3560__auto____$1;
} else
...
taoensso.sente.interfaces.EdnPacker.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opt__4129__auto__){return cljs.core._write.call(null,writer__4128__auto__,"taoensso.sente.interfaces/EdnPacker");
});
...
{if((function (){var G__15909 = x;if(G__15909)
...
{return G__15909.taoensso$sente$interfaces$IPacker$;
}
})()))
{return true;
} else
{if((!G__15909.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,taoensso.sente.interfaces.IPacker,G__15909);
} else
{return false;
}
}
