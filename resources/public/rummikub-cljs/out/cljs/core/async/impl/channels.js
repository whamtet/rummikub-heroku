...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15257 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15257 = (function (val,box,meta15258){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15257.cljs$lang$type = true;
cljs.core.async.impl.channels.t15257.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15257";
cljs.core.async.impl.channels.t15257.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opt__4129__auto__){return cljs.core._write.call(null,writer__4128__auto__,"cljs.core.async.impl.channels/t15257");
});
cljs.core.async.impl.channels.t15257.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15257.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15259){var self__ = this;
var _15259__$1 = this;return self__.meta15258;
});
cljs.core.async.impl.channels.t15257.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15259,meta15258__$1){var self__ = this;
var _15259__$1 = this;return (new cljs.core.async.impl.channels.t15257(self__.val,self__.box,meta15258__$1));
});
cljs.core.async.impl.channels.__GT_t15257 = (function __GT_t15257(val__$1,box__$1,meta15258){return (new cljs.core.async.impl.channels.t15257(val__$1,box__$1,meta15258));
});
}
return (new cljs.core.async.impl.channels.t15257(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj15261 = {};return obj15261;
})();
...
{}
while(true){
var taker_15262 = self__.takes.pop();if((taker_15262 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15262))
{var take_cb_15263 = cljs.core.async.impl.protocols.commit.call(null,taker_15262);var val_15264 = (cljs.core.truth_((function (){var and__3548__auto__ = self__.buf;if(cljs.core.truth_(and__3548__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3548__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15263,val_15264,taker_15262,this$__$1){
return (function (){return take_cb_15263.call(null,val_15264);
});})(take_cb_15263,val_15264,taker_15262,this$__$1))
);
} else
{}
{
...
{} else
{var putter_15265 = self__.puts.pop();if((putter_15265 == null))
{} else
{var put_handler_15266 = putter_15265.handler;var val_15267 = putter_15265.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15266))
{var put_cb_15268 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15266);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15268,put_handler_15266,val_15267,putter_15265,_,retval,this$__$1){
return (function (){return put_cb_15268.call(null,true);
});})(put_cb_15268,put_handler_15266,val_15267,putter_15265,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_15267)))
...
{var taker_15269 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15269))
{var take_cb_15270 = cljs.core.async.impl.protocols.commit.call(null,taker_15269);var val_15271__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15270,val_15271__$1,taker_15269,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_15270.call(null,val_15271__$1);
});})(take_cb_15270,val_15271__$1,taker_15269,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_15272 = self__.puts.pop();if((putter_15272 == null))
{} else
{var put_handler_15273 = putter_15272.handler;var val_15274 = putter_15272.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15273))
{var put_cb_15275 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15273);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15275,put_handler_15273,val_15274,putter_15272,this$__$1){
return (function (){return put_cb_15275.call(null,true);
});})(put_cb_15275,put_handler_15273,val_15274,putter_15272,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__15280 = null;
var G__15280__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e15278){var t = e15278;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__15280__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e15279){var t = e15279;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__15280 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__15280__1.call(this,buf__$1);
case 2:
return G__15280__2.call(this,buf__$1,val);
}
