...
launch from the command line:
    ...
    $ lein run -m rummikub-heroku.web
...
get the app created:
    ...
    $ heroku apps:create rummikub-heroku
    Creating rummikub-heroku... done, stack is cedar
    http://rummikub-heroku.herokuapp.com/ | git@heroku.com:rummikub-heroku.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://rummikub-heroku.herokuapp.com deployed to Heroku

    To git@heroku.com:rummikub-heroku.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://rummikub-heroku.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@rummikub-heroku.herokuapp.com/repl
